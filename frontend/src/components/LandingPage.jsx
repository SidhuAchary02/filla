    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_90%_10%,#ffceb8_0%,#f7f4ee_42%),radial-gradient(circle_at_10%_80%,#ffd56f_0%,#f7f4ee_32%)] text-[#1f1c17] font-[monospace]">
            ...
            <header className="fixed inset-x-0 top-0 z-20">
                <div className="mx-auto mt-2 flex w-[min(1120px,calc(100%-2rem))] items-center justify-between rounded-full border border-[#d9cebc] bg-[color-mix(in_srgb,#fffdf8_88%,transparent)] px-4 py-2 backdrop-blur-md max-[720px]:flex-wrap max-[720px]:gap-3">
                    ...
                    <nav className="flex gap-5 font-semibold max-[1024px]:hidden">
                        ...
                        <a className="text-[#635a4b] no-underline transition hover:text-[#1f1c17]" href="#start">
                            Start
                        </a>
                    </nav>
                    <div className="inline-flex flex-wrap gap-3 max-[720px]:w-full">
                        <Link
                            to="/login"
                            className="rounded-full border border-[#d9cebc] bg-[color-mix(in_srgb,white_78%,transparent)] px-4 py-2.5 text-center font-bold text-[#1f1c17] transition hover:-translate-y-0.5"
                        >
                            Log in
                        </Link>
                        <Link
                            to="/signup"
                            className="rounded-full bg-linear-to-br from-[#da5a2a] to-[#9e2f09] px-4 py-2.5 text-center font-bold text-white shadow-[0_8px_20px_rgba(158,47,9,0.25)] transition hover:-translate-y-0.5"
                        >
                            Get started
                        </Link>
                    </div>
            ...
            <main className="pt-24">
                <section
                    className="relative z-1 mx-auto w-[min(1120px,calc(100%-2rem))] scroll-mt-24 px-0 pb-12 pt-16 max-[720px]:pt-10"
                    id="start"
                >
                    ...
                    <div className="mt-6 inline-flex flex-wrap gap-3">
                        <Link
                            to="/signup"
                            className="rounded-full bg-linear-to-br from-[#da5a2a] to-[#9e2f09] px-5 py-3 text-[0.98rem] font-bold text-white shadow-[0_8px_20px_rgba(158,47,9,0.25)] transition hover:-translate-y-0.5"
                        >
                            Create free account
                        </Link>
                        <Link
                            to="/dashboard"
                            className="rounded-full border border-[#d9cebc] bg-[color-mix(in_srgb,white_78%,transparent)] px-5 py-3 text-[0.98rem] font-bold text-[#1f1c17] transition hover:-translate-y-0.5"
                        >
                            Open dashboard
                        </Link>
                    </div>
                    <div className="mt-8 grid grid-cols-3 gap-3 max-[1024px]:grid-cols-2 max-[720px]:grid-cols-1">
                        <article className="rounded-[18px] border border-[#d9cebc] bg-[color-mix(in_srgb,#fffdf8_88%,white)] p-4 backdrop-blur-md">
                ...
                >
                    {highlights.map((item) => (
                        <article
                            className="rounded-[18px] border border-[#d9cebc] bg-[color-mix(in_srgb,#fffdf8_88%,white)] p-[1.15rem] backdrop-blur-md"
                            key={item.title}
                        >
                ...
                >
                    ...
                    <div className="mt-5 grid grid-cols-3 gap-3 max-[1024px]:grid-cols-2 max-[720px]:grid-cols-1">
                        {steps.map((step) => (
                            <article
                                className="rounded-[18px] border border-[#d9cebc] bg-[color-mix(in_srgb,#fffdf8_88%,white)] p-4 backdrop-blur-md"
                                key={step.number}
                            >
                ...
                <section className="relative z-[1] mx-auto mb-11 mt-4 w-[min(1120px,calc(100%-2rem))] rounded-[18px] border border-[#d9cebc] bg-[color-mix(in_srgb,#fffdf8_88%,white)] p-6 backdrop-blur-md max-[720px]:mb-8">
